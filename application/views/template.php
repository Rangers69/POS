...
<body class="hold-transition skin-blue sidebar-mini <?= $this->uri->segment(1) == 'sale' ? 'sidebar-collapse' : null ?>">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="<?= base_url('auth/logout') ?>" class="btn btn-flat bg-red">Sign out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li <?= $this->uri->segment(1) == 'supplier' || $this->uri->segment(1) == '' ? 'class="active"' : '' ?>>
                    ...
                    <li class="treeview <?= $this->uri->segment(1) == 'stock' || $this->uri->segment(1) == 'sale' ? 'active' : '' ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li <?= $this->uri->segment(1) == 'stock' && $this->uri->segment(2) == 'out' ? 'class="active"' : '' ?>><a href="<?= base_url('stock/out') ?>"><i class="fa fa-circle-o"></i> Stock Out</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                    ...
                    <?php if ($this->fungsi->user_login()->level == 1) { ?>
                        ...
                        <li <?= $this->uri->segment(1) == 'user' || $this->uri->segment(1) == '' ? 'class="active"' : '' ?>>
                            <a href="<?= base_url('user') ?>"><i class="fa fa-user"></i> <span>Users</span></a>
                        </li>
                    <?php } ?>
                </ul>
            </section>
    ...
    <script src="<?= base_url() ?>assets/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2020 <a href="https://yukcoding.id">A.W</a>.</strong> All rights reserved.
        </footer>
