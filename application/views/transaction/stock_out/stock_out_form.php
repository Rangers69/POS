                    ...
                    <form action="<?= base_url('stock/process') ?>" method="post">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <label for="unit_name">Initial Stcok</label>
                                    <input type="text" name="stock" id="stock" value="" class="form-control" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Info <span style="color:red">*</span></label>
                            <input type="text" name="detail" class="form-control" placeholder="Rusak / hilang / etc" required>
                        </div>
                        <div class="form-group">
                            <label for="">Qty <span style="color:red">*</span></label>
