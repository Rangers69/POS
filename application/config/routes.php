...
// $route['pelanggan/add'] = 'customer/add';
// $route['pelanggan/process'] = 'customer/process';
// $route['pelanggan/edit/(:num)'] = 'customer/edit/$1';
// $route['pelanggan/del(:num)'] = 'customer/del/$1';
